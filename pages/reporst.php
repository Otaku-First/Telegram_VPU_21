        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    $get_reports_sql= mysqli_query($db,'SELECT * FROM `report`');
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                    <?
                                    while( $get_reports_arr = mysqli_fetch_array($get_reports_sql)){

                                        ?>
                                        <tr data-dell-id="<? echo $get_reports_arr["id"]; ?>">
                                            <td><? echo $get_reports_arr["id"]; ?></td>
                                            <!--<td><a href="#"><img src="/examples/images/avatar/1.jpg" class="avatar" alt="Avatar"> Michael Holz</a></td>-->
                                            <td><? echo $get_reports_arr["chat_id"]; ?></td>
                                            <td><? echo $get_reports_arr["text"]; ?></td>

                                            <td><?php echo date("Y-m-d H:i:s",$get_reports_arr["input_date"]); ?></td>
                                            <!--                                            <td>--><?// echo $get_groups_arr["manager"]; ?><!--</td>-->
                                            <td>
                                                <a href="#" data-toggle="modal" data-target="#editgroup<? echo $get_reports_arr["id"]; ?>" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
                                                <a href="#" class="delete" title="Delete" data-dell="<? echo $get_reports_arr["id"]; ?>" data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
                                            </td>
                                        </tr>
