...
if (!isset($_SESSION["session_email"])):
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    ?><br>
                    <h1>Надсилання сповіщення по заміни</h1>
                    <hr>
                    <div></div>
                    ...
                    <div class="form-group">
                        <label for="message_text">Текст заміни</label>
                        ...
                        <button class="btn btn-primary" id="su_send_mess">Надіслати сповіщення про заміну</button></div>
                </div>
            </main>
    ...
    <script>
        $(document).on("click","#su_send_mess",function (){
            ...
            var mess_group = "Заміна на " + day + ":\n" + CKEDITOR.instances['message_text'].getData();
