...
while( $get_admins_arr = mysqli_fetch_array($get_admins_sql)){$ad_mds .= "<option value='".$get_admins_arr["id"]."'>".$get_admins_arr["full_name"]."</option>";}
                    ...
                    <tr data-dell-id="<? echo $get_groups_arr["id"]; ?>">
                        ...
                        <td><? echo $get_groups_arr["number"]; ?></td>                        
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Редагування групи</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="form-group">
    <label>Номер групи</label>
    <input type="number" autocomplete="off" value="<? echo $get_groups_arr["number"]; ?>" class="form-control" id="edit_number<? echo $get_groups_arr["id"]; ?>">
   
  </div>
  <div class="form-group">
    <label >Коротка назва</label>
    <input type="text "autocomplete="off" value="<? echo $get_groups_arr["short_name"]; ?>" class="form-control" id="edit_short_name<? echo $get_groups_arr["id"]; ?>">
  </div>
  <div class="form-group">
    <label >Повна назва</label>
    <input type="text" autocomplete="off" value="<? echo $get_groups_arr["full_name"]; ?>" class="form-control" id="edit_full_name<? echo $get_groups_arr["id"]; ?>">
  </div>
  <div class="form-group">
    <label >Староста</label>
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
        ...
        <script>
            ...
            .on("click",'a[data-dell]',function (){
               ...
               swal({
  title: "Ви дійсно хочене видалити цю групу?",
